...
class Constants {
  ...
  getObjectInstance(viewer, raw_object) {
    return this.Objects[raw_object.type]
      ? new this.Objects[raw_object.type].instance(this, viewer, raw_object)
      : new GObject(this, viewer, raw_object);
  }

  getEdgeInstance(viewer, raw_edge) {
    return this.Edges[raw_edge.type]
      ? new this.Edges[raw_edge.type].instance(this, viewer, raw_edge)
      : new GEdge(this, viewer, raw_edge);
  }
}
