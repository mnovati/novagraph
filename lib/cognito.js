    ...
    try {
      ...
      if (uuid) {
        ...
        if (result) {
          ...
          await this._DB.createEdge(viewer, this._DB.Constants.getEdgeInstance(this._DB, viewer, {from_id: uuid, to_id: profile_id, type: this._DB.Constants.COGNITO_EDGE}));
          return profile_id;
        }
      }
    ...
    try {
      ...
      if (uuid) {
        ...
        if (object_id) {
          ...
          await this._DB.createEdge(viewer, this._DB.Constants.getEdgeInstance(this._DB, viewer, {from_id: uuid, to_id: object_id, type: this._DB.Constants.COGNITO_EDGE}));
