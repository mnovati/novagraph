...
class DB {
  ...
  static async createObject(viewer, type, data) {
    ...
    temp_object = checkObjectTypes(viewer, temp_object);
  ...
  static async modifyObject(viewer, object) {
    ...
    object = checkObjectTypes(viewer, object);
